...
def MMbuttonclicked():
    ...
    MMwindow.geometry('1000x1900')

    Blank0=Label(MMwindow, justify = CENTER, text = " ",font=("Arial", 18))
    Blank0.grid(row=0, column=0)
    #Heading row
    lblFPModeHead = Label(MMwindow, justify = CENTER, text="Manual Mode",font=("Arial",8))
    lblFPSpeedHead = Label(MMwindow, justify = CENTER, text="Speed",font=("Arial",8))
    lblFPAuxHead = Label(MMwindow, justify = CENTER, text="Aux",font=("Arial",8))
    lblFPWaterfallsHead = Label(MMwindow, justify = CENTER, text="Waterfalls",font=("Arial",8))
    ...
    #Program 1 row
    txt20 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    txt11 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    txt12 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    txt13 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    Row11=Label(MMwindow, justify = CENTER, text = "Swim",font=("Arial",8))
    ...
    #Program 2 row
    txt20 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    txt21 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    txt22 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    txt23 = Entry(MMwindow, justify = CENTER, width=6,font=("Arial",8))
    Row21=Label(MMwindow, justify = CENTER, text = "Clean",font=("Arial",8))
    ...
    CancelButton = Button(MMwindow, justify = CENTER, text="Cancel", bg = 'black', fg='white', font=("Arial",8), command=MMCancelClicked)
    CancelButton.place(x = 200, y = 400)

    Blank2=Label(MMwindow, justify = CENTER, text = "",font=("Arial", 2))
#    Blank2.grid(row=12, column=1)

    UpdateButton = Button(MMwindow, justify = CENTER, text="Update", bg='Green', fg='white', font = ("Arial",8), command=MMUpdateClicked)
    UpdateButton.place(x = 600, y= 400)

#    Blank3=Label(MMwindow, justify = CENTER, text = "",font=("Arial",8))
#    Blank3.grid(row=14, column=1)

    Disclaim0=Label(MMwindow, justify = CENTER, text = "For Waterfalls and Aux, \n use 1 for 'run', 0 for 'don't run'",font=("Arial",8))
    Disclaim0.place(x=200, y=600)
    
    Disclaim1=Label(MMwindow, justify = CENTER, text = "Use only allowed Pump Speeds:",font=("Arial",8))
    Disclaim1.place(x=200, y=700)
    ...
    Disclaim1=Label(MMwindow, justify = CENTER, text = speedtext,font=("Arial",8))
    Disclaim1.place(x=450, y=800)
...
def TTbuttonclicked():
    ...
    TTwindow.geometry('1000x1900')

    Title0 = Label(TTwindow, text = "",font=("Arial", 20), bg=wc)

    Blank0=Label(TTwindow, justify = CENTER, text = "",font=("Arial", 8))
    Blank0.grid(row=0, column=0)
    ...
    #Program 1 row
    txt11 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8))
    txt12 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt13 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt14 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt15 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt16 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt17 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    Row10=Label(TTwindow, text = "1", font=("Arial",8))
    ...
    #Program 2 row
    txt21 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8), bg ='#DDFFFF')
    txt22 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt23 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt24 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt25 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt26 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt27 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    Row20=Label(TTwindow, text = "2", font=("Arial",8))
    ...
    #Program 3 row
    txt31 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8))
    txt32 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt33 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt34 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt35 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt36 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt37 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    Row30=Label(TTwindow, text = "3", font=("Arial",8))
    ...
    #Program 4 row
    txt41 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8), bg ='#DDFFFF')
    txt42 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt43 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt44 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt45 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt46 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt47 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    Row40=Label(TTwindow, text = "4", font=("Arial",8))
    ...
    #Program 5 row
    txt51 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8))
    txt52 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt53 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt54 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt55 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt56 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt57 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    Row50=Label(TTwindow, text = "5", font=("Arial",8))
    ...
    #Program 6 row
    txt61 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8), bg ='#DDFFFF')
    txt62 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt63 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt64 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt65 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt66 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt67 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    Row60=Label(TTwindow, text = "6", font=("Arial",8))
    ...
    #Program 7 row
    txt71 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8))
    txt72 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt73 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt74 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt75 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8))
    txt76 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    txt77 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8))
    Row70=Label(TTwindow, text = "7", font=("Arial",8))
    ...
    #Program 8 row
    txt81 = Entry(TTwindow, justify = CENTER, width=26, font=("Arial",8), bg ='#DDFFFF')
    txt82 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt83 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt84 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt85 = Entry(TTwindow, justify = CENTER, width=6, font=("Arial",8), bg ='#DDFFFF')
    txt86 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    txt87 = Entry(TTwindow, justify = CENTER, width=3, font=("Arial",8), bg ='#DDFFFF')
    Row80=Label(TTwindow, text = "8", font=("Arial",8))
    ...
    Disclaim0=Label(TTwindow, justify = CENTER, text = \
"WARNING: DO NOT SET Start Time = Stop Time\n \
Do not run Aux and Waterfall at the same time.\n \
* E = timer program Enabled, W = Waterfalls\n \
Programs which are not Enabled will not run\n \
For Waterfalls and Aux, \n \
use 1 for 'run', 0 for 'don't run'\n \
Lower numbered programs take priority\n \
over higher numbered rograms",font=("Arial", 8))
    
    Disclaim0.place(x=50, y=625)

    CancelButton = Button(TTwindow, text="Cancel", bg = 'black', fg='white', font=("Arial",8),command=TTCancelClicked)
    CancelButton.place(x = 100, y = 1100)

    UpdateButton = Button(TTwindow, text="Update", bg='Green', fg='white', font=("Arial",8), command=TTUpdateClicked)
    UpdateButton.place(x = 500, y= 1100)
    
    Disclaim4=Label(TTwindow, justify = CENTER, text = "Use only allowed Pump Speeds:",font=("Arial", 8))
    Disclaim4.place(x=100, y=1250)

    speedtext=str(SpeedTable[1].speed)+"\n"+str(SpeedTable[2].speed)+"\n"+str(SpeedTable[3].speed)+"\n"+str(SpeedTable[4].speed)\
               +"\n"+str(SpeedTable[5].speed)+"\n"+str(SpeedTable[6].speed)+"\n"+str(SpeedTable[7].speed)+"\n"+str(SpeedTable[8].speed)
    Disclaim5=Label(TTwindow, justify = CENTER, text = speedtext,font=("Arial", 8))
    Disclaim5.place(x=400, y=1350)
...
def FTbuttonclicked():
    ...
    FTwindow.geometry('1000x1900')

    Blank0=Label(FTwindow, justify = CENTER, text = "     ",font=("Arial", 10))
    Blank0.grid(row=0, column=0)
    
    #Heading row
    lblFPModeHead = Label(FTwindow, text="Mode",font=("Arial", 9))
    lblFPTempHead = Label(FTwindow, text="Temp",font=("Arial", 9))
    lblFPSpeedHead = Label(FTwindow, text="Speed",font=("Arial", 9))
    lblFPAuxHead = Label(FTwindow, text="Aux",font=("Arial", 9))
    ...
    #Level Zero row
    txt10 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt11 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt12 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt13 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    Row10=Label(FTwindow, text = "Off",font=("Arial", 9),width=6)
    ...
    #Level One row
    txt20 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt21 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt22 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt23 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    Row20=Label(FTwindow, text = "Level 1",font=("Arial", 9),width=6)
    ...
    #Level Two row
    txt30 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt31 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt32 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt33 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    Row30=Label(FTwindow, text = "Level 2",font=("Arial", 9),width=6)
    ...
    #Level Three row
    txt40 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt41 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt42 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt43 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt43 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    Row40=Label(FTwindow, text = "Level 3",font=("Arial", 9),width=6)
    ...
    #Level Four row
    txt50 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt51 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt52 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    txt53 = Entry(FTwindow, justify = CENTER, width=6,font=("Arial", 9))
    Row50=Label(FTwindow, text = "Level 4",font=("Arial", 9),width=6)
    ...
    Blank1=Label(FTwindow, justify = CENTER, text = "",font=("Arial", 12))
    Blank1.grid(row=9, column=1)
    CancelButton = Button(FTwindow, text="Cancel", bg = 'black', fg='white', font=("Arial", 9), command=FTCancelClicked)
    CancelButton.place(x = 200, y = 600)
    Blank2=Label(FTwindow, justify = CENTER, text = "", font=("Arial", 2))
    Blank2.grid(row=11, column=1)
    UpdateButton = Button(FTwindow, bg='Green', fg='white', text="Update",font=("Arial", 9), command=FTUpdateClicked)
    UpdateButton.place(x = 550, y= 600)
...
#    Blank3=Label(FTwindow, justify = CENTER, text = "",font=("Arial", 9))
#    Blank3.grid(row=14, column=1)

    Disclaim0=Label(FTwindow, justify = CENTER, text = "For Waterfalls and Aux, \n use 1 for 'run', 0 for 'don't run'",font=("Arial", 9))
    Disclaim0.place(x=100, y=800)
    
    Disclaim1=Label(FTwindow, justify = CENTER, text = "Use only allowed Pump Speeds:",font=("Arial", 9))
    Disclaim1.place(x=100, y=950)

    speedtext=str(SpeedTable[1].speed)+"\n"+str(SpeedTable[2].speed)+"\n"+str(SpeedTable[3].speed)+"\n"+str(SpeedTable[4].speed)\
               +"\n"+str(SpeedTable[5].speed)+"\n"+str(SpeedTable[6].speed)+"\n"+str(SpeedTable[7].speed)+"\n"+str(SpeedTable[8].speed)
    Disclaim1=Label(FTwindow, justify = CENTER, text = speedtext,font=("Arial", 9))
    Disclaim1.place(x=400, y=1050)
...
def PSbuttonclicked():
    ...
    PSwindow.geometry('1000x1900')
    
    Blank0=Label(PSwindow, justify = CENTER, text = "            ",font=("Arial", 2))
    Blank0.grid(row=0, column=0)

    #Heading row
    lblFPModeHead = Label(PSwindow, text="Pump Timer Speed", font=("Arial",8))
    lblFPSpeedHead = Label(PSwindow, text="Speed", font=("Arial",8))
    lblFPModeHead.grid(row=1,column=1)
    lblFPSpeedHead.grid(row=1,column=2)

    #Speed 1 row
    Row10=Label(PSwindow, text = "1", font=("Arial",8))
    txt11 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row10.grid(row=2, column=1)
    txt11.grid(row=2, column=2)
    txt11.insert(0,SpeedTable[1].speed)

    #Speed 2 row
    Row20=Label(PSwindow, text = "2", font=("Arial",8))
    txt21 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row20.grid(row=3, column=1)
    txt21.grid(row=3, column=2)
    txt21.insert(0,SpeedTable[2].speed)

    #Speed 3 row
    Row30=Label(PSwindow, text = "3", font=("Arial",8))
    txt31 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row30.grid(row=4, column=1)
    txt31.grid(row=4, column=2)
    txt31.insert(0,SpeedTable[3].speed)

    #Speed 4 row
    Row40=Label(PSwindow, text = "4", font=("Arial",8))
    txt41 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row40.grid(row=5, column=1)
    txt41.grid(row=5, column=2)
    txt41.insert(0,SpeedTable[4].speed)

    #Speed 5 row
    Row50=Label(PSwindow, text = "5", font=("Arial",8))
    txt51 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row50.grid(row=6, column=1)
    txt51.grid(row=6, column=2)
    txt51.insert(0,SpeedTable[5].speed)

    #Speed 6 row
    Row60=Label(PSwindow, text = "6", font=("Arial",8))
    txt61 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row60.grid(row=7, column=1)
    txt61.grid(row=7, column=2)
    txt61.insert(0,SpeedTable[6].speed)

    #Speed 7 row
    Row70=Label(PSwindow, text = "7", font=("Arial",8))
    txt71 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
    Row70.grid(row=8, column=1)
    txt71.grid(row=8, column=2)
    txt71.insert(0,SpeedTable[7].speed)

    #Speed 8 row
    Row80=Label(PSwindow, text = "8", font=("Arial",8))
    txt81 = Entry(PSwindow, justify = CENTER, width=8, font=("Arial",8))
...
def FreezeProtect():
    ...
    if CV.FPL > 0:
        ...
        Info1.config(text = ("  "))
        Info2.config(text = ("Freeze Protection: Level "+str(CV.FPL)),font = ('Arial', 10), fg='dark red', bg=wc)
        Info3.config(text = ("  "))
...
def TimerLogic():
    ...
    if CV.FPL == 0 and ManualSwim.enabled == 0 and ManualClean.enabled == 0:
        ...
        if CV.Timer != 0:
            Info1.config(text = "Current Timer in Use:",font = ('Arial', 9), fg='black', bg=wc)
            Info2.config(text = "Timer "+str(CV.Timer)+": "+str(Timer[CV.Timer].name),font = ('Arial', 10), fg='black', bg=wc)

            #print("TTG: ",Timer[CV.Timer].TTG, "Next: " ,MinutesToNextTimer)
            if Timer[CV.Timer].TTG < MinutesToNextTimer:
                Info3.config(text = "Terminates at "+str(Timer[CV.Timer].stop),font = ('Arial', 10), fg='black', bg=wc)
            else:
                Info3.config(text = "Timer "+str(CV.NextTimer)+" will start at "+str(Timer[CV.NextTimer].start),font = ('Arial', 10), fg='black', bg=wc)    
...
Title0.pack()
Title1 = Label(MMwindow, text = "Raspberry Pi\nCustom Pool Pump Controller",font=("Arial", 10,'bold'), bg=wc)
Title1.pack()
Title2 = Label(MMwindow, text = "Version 0.001",font=("Arial", 8), bg=wc)
Title2.pack()
Title3 = Label(MMwindow, text = "Designed and implemented by David Jeffreys",font=("Arial", 8), bg=wc)
Title3.pack()
...
#Manual Swim Button
MSbutton = Button(MMwindow, width=20, text="Manual Swim is OFF", font = ('Arial',10, 'bold') , bg = 'black', fg='white', borderwidth = 5, command=turnMSon)
...
MCbutton = Button(MMwindow, width=20, text="Manual Clean is OFF", font = ('Arial',10, 'bold') ,
...
Infospace.pack()
Info0 = Label(MMwindow, text = "",font = ('Arial', 10), bg=wc)
Info0.pack()
InfoAT = Label(MMwindow, text = "Air Temperature is ... ",font = ('Arial', 10), bg=wc)
InfoAT.pack()
InfoWT = Label(MMwindow, text = "Water Temperature is ...",font = ('Arial', 10), fg='black', bg=wc)
InfoWT.pack()
Infospace = Label(MMwindow, text = "",font = ('Arial', 4), bg=wc)
Infospace.pack()
Info1 = Label(MMwindow, text = "Current Timer in Use:",font = ('Arial', 10), bg=wc)
Info1.pack()
Info2 = Label(MMwindow, text = "High Speed",font = ('Arial', 10), bg=wc)
Info2.pack()
Info3 = Label(MMwindow, text = "Terminates at 1700",font = ('Arial', 10), bg=wc)
Info3.pack()
...
#Timer Tables Button
TTbutton = Button(MMwindow, width=28, text="Timer Tables", font = ('Arial',10), borderwidth = 7,command=TTbuttonclicked)
TTbutton.pack(pady=5)

#Freeze Protection Button
FPbutton = Button(MMwindow, width=28, text="Freeze Protect Tables", font = ('Arial',10), borderwidth = 7, command=FTbuttonclicked )
FPbutton.pack(pady=5)

#Pump Speeds Button
PSbutton = Button(MMwindow, width=28, text="Pump Speed Tables", font = ('Arial',10), borderwidth = 7, command=PSbuttonclicked )
PSbutton.pack(pady=5)

#Manual Modes Button
MMbutton = Button(MMwindow, width=28, text="Manual Mode Tables", font = ('Arial',10), borderwidth = 7, command=MMbuttonclicked )
MMbutton.pack()

Info5 = Label(MMwindow, text = "Main Pump is ...",font = ('Arial', 10), bg=wc)
Info5.pack()

Info6 = Label(MMwindow, text = "Aux Pump is ...",font = ('Arial', 10), bg=wc)
Info6.pack()

#Info7 = Label(MMwindow, text = "Waterfalls are ...",font = ('Arial', 11), bg=wc)
#Info7.pack()

Info8 = Label(MMwindow, text = "Server Time is:",font = ('Arial', 10), bg=wc)
Info8.pack()

#Close Socket Button
def CloseSocket():
    CV.socket = 0
    CSbutton.config(text="Closing socket and exiting",font = ('Arial',10, 'bold'), bg = 'red', fg='white')
    print("CV.Socket = ",CV.socket)

CSbutton = Button(MMwindow, width=28, text="Close Socket", font = ('Arial',10), borderwidth = 7,command=CloseSocket)
CSbutton.pack()
